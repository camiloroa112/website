                ...
                <div class="row pt-3">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 pb-3">
                        ...
                        <div class="background pb-3">
                            ...
                            <div class="px-2">
                                <p class="project-desc">Python project showcasing the efficient frontier graph, representing the profit maximization subject to the risk. It allows identifying the optimal point where with a combination of assets yields higher returns based on the assumed risk in the operation.</p>
                                <p>Source code:
                                    <a title="In Progress">

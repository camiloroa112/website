                ...
                <div class="row pt-3">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 pb-3">
                        ...
                        <div class="background pb-3">
                            ...
                            <div class="px-2">
                                <p class="project-desc">Python project showcasing the efficient frontier graph, which represents the profit maximization subject to the risk. It allows identifying the optimal point where with a combination of assets yields higher returns based on the assumed risk in the operation.</p>
                                <p>Source code:
                                    <a title="In Progress">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 pb-1">
                        ...
                        <div class="background pb-3">
                            ...
                            <div class="px-2">
                                <p class="project-desc">Presentation of the public repository on GitHub which contains the files used in the development of the current website. The page responsiveness was designed with Bootstrap, dynamic loading of elements using Ajax, and styling with CSS3.</p>
                                <p>Source code:
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 pb-3">
                        ...
                        <div class="background pb-3">
                            ...
                            <div class="px-2">
                                <p class="project-desc">Python script developed to send emails iteratively with a preconfigured HTML format, having a standard text and autofile attachment in Outlook. Recipients are specified through an Excel file, with an additional option for preserving the format of email replies.</p>
                                <p>Source code:
